...
internal class CollectAllCommand : ConfirmableCommand
{
    internal override bool IsMatch(string[] args)
    {
        ...
        if (!KeywordUtils.IsAllArgument(arg1))
        {
            return false;
        }
    ...
    internal override ExecuteResult ExecuteConfirm()
    {
        ...
        builder.AppendLine("All items have been collected from the cruiser.");
